...
//   double fr_left = 950.0, fr_down = 3.0E-1, fr_right = 1050.0, fr_up = 3.5E-1;
   double fr_left = 1900.0, fr_down = 1.125E-1, fr_right = 2100.0, fr_up = 1.5E-1;
//   double fr_left = 500.0, fr_down = 7E-2, fr_right = 4500.0, fr_up = 2E0;
...
// end loop
  ...
  hr->SetYTitle("95% #sigma_{Z'}xBR(Z'->ZH) [pb]");
    ...
    latex->DrawLatex(0.25, 0.87, "CL_{S} Expected Limit, cut electron leading pt");
