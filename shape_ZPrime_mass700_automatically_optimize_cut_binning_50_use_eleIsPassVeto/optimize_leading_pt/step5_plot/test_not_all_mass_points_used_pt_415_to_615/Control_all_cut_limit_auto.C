...
//  if(cut_value[i]==515) {nXm = 10;}
  ...
  if(cut_value[i]==515) {nXm = 11;}// no lost 
  if(cut_value[i]==535) {nXm = 10;}// lost M800
  if(cut_value[i]==555) {nXm = 10;}// lost M800
  if(cut_value[i]==575) {nXm = 10;}// lost M800
  if(cut_value[i]==595) {nXm = 10;}// lost M800
...
//   double fr_left = 1500.0, fr_down = 8E-2, fr_right = 2500.0, fr_up = 2E-1;
   double fr_left = 2900.0, fr_down = 9.5E-2, fr_right = 3100.0, fr_up = 1.0E-1;
