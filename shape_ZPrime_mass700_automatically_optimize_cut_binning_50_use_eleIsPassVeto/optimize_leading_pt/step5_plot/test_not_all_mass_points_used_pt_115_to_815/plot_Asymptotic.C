...
//void plot_Asymptotic(string outputname)
//void plot_Asymptotic()
TGraphAsymmErrors *  plot_Asymptotic(TString dir_path ,TGraphAsymmErrors *grmedian_cls, int nxm ) 
...
//  int Xmass[nXm]={800,1000,1200,1400,1600,1800,2000,2500,3000,3500,4000};
    int X_mass[11]={800,1000,1200,1400,1600,1800,2000,2500,3000,3500,4000}; 
  int Xmass[nXm];

  if(nXm==11){
	for(int i=0;i<nXm;i++){ Xmass[i]= X_mass[i];}
  }

  if(nXm==10){
        for(int i=0;i<nXm;i++){ Xmass[i]= X_mass[i+1];}
  }

  if(nXm==8){
        for(int i=0;i<nXm;i++){ Xmass[i]= X_mass[i+3];}
  }

  for(int i=0;i<nXm;i++) {cout<<"Xmass[i]: "<< Xmass[i] << endl;}
...
string xsect_file_th = dirXSect + "13TeV_xsec_Zh.txt";
  ...
  for (int im = 0; im < nXm; im++) {
    ...
    int index_to_get_v_xs;
    if(nXm==11){index_to_get_v_xs= im;}
    if(nXm==10){index_to_get_v_xs= im+1;}
    if(nXm==8){index_to_get_v_xs= im+3;}

//    double fl_xs = double(v_xs.at(im)); //*1000.0
    double fl_xs = double(v_xs.at( index_to_get_v_xs ));
...
//      cout<<endl<< "v_median.at(im): "<< v_median.at(im) << " fl_xs:  "<< fl_xs <<endl<< endl;      
