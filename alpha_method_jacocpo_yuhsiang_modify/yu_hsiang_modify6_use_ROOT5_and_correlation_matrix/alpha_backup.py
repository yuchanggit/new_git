...
#        widthVjet_test.Print()
	...
	# use the shape of fit to generate the psudo-data
        ...
        pseudo_data = modelVjet_test.generate(RooArgSet(J_mass),nPseudo_data )
...
#        frVjet_test2 = modelVjet_test2.fitTo(pseudo_data_SB, RooFit.SumW2Error(True), RooFit.Range("h_reasonable_range"), RooFit.Strategy(2), RooFit.Minimizer(minimizer_choose), RooFit.Save(1), RooFit.PrintLevel(1 if VERBOSE else -1))
	...
	# test integral of modelVjet_test2
	print ""
	Area_temp = 0

#        iTest2 = modelVjet_test2.createIntegral(RooArgSet(J_mass), RooFit.Range("h_reasonable_range"))
#        print "iTest2 all range:", iTest2.getVal()
#        iTest2 = modelVjet_test2.createIntegral(RooArgSet(J_mass), RooFit.Range("LSBrange,HSBrange"))
#        print "iTest2 SB only:", iTest2.getVal()
#	Area_temp = Area_temp + iTest2.getVal()
#        iTest2 = modelVjet_test2.createIntegral(RooArgSet(J_mass), RooFit.Range("VRrange,SRrange"))
#        print "iTest2 VR+SR:", iTest2.getVal()
#        Area_temp = Area_temp + iTest2.getVal()
#	print "SB+[VR+SR]:", Area_temp 

#        iTest2 = modelVjet_test2.createIntegral(jetMassArg, RooFit.Range("h_reasonable_range"))
#        print "iTest2 all range:", iTest2.getVal()
#        iTest2 = modelVjet_test2.createIntegral(jetMassArg, RooFit.Range("LSBrange,HSBrange"))
#        print "iTest2 SB only:", iTest2.getVal()
#        Area_temp = Area_temp + iTest2.getVal()
#        iTest2 = modelVjet_test2.createIntegral(jetMassArg, RooFit.Range("VRrange,SRrange"))
#        print "iTest2 VR+SR:", iTest2.getVal()
#        Area_temp = Area_temp + iTest2.getVal()
#        print "SB+[VR+SR]:", Area_temp 

#        iTest2 = modelVjet_test2.createIntegral(RooArgSet(J_mass),RooFit.NormSet(jetMassArg), RooFit.Range("h_reasonable_range"))
#        print "iTest2 all range:", iTest2.getVal()
#        iTest2 = modelVjet_test2.createIntegral(RooArgSet(J_mass),RooFit.NormSet(jetMassArg), RooFit.Range("LSBrange,HSBrange"))
#        print "iTest2 SB only:", iTest2.getVal()
#        Area_temp = Area_temp + iTest2.getVal()
#        iTest2 = modelVjet_test2.createIntegral(RooArgSet(J_mass),RooFit.NormSet(jetMassArg), RooFit.Range("VRrange,SRrange"))
#        print "iTest2 VR+SR:", iTest2.getVal()
#        Area_temp = Area_temp + iTest2.getVal()
#        print "SB+[VR+SR]:", Area_temp 

#        iTest2 = modelVjet_test2.createIntegral(jetMassArg,RooFit.NormSet(jetMassArg), RooFit.Range("h_reasonable_range"))
#        print "iTest2 all range:", iTest2.getVal()
#        iTest2 = modelVjet_test2.createIntegral(jetMassArg,RooFit.NormSet(jetMassArg), RooFit.Range("LSBrange,HSBrange"))
#        print "iTest2 SB only:", iTest2.getVal()
#        Area_temp = Area_temp + iTest2.getVal()
#        iTest2 = modelVjet_test2.createIntegral(jetMassArg,RooFit.NormSet(jetMassArg), RooFit.Range("VRrange,SRrange"))
#        print "iTest2 VR+SR:", iTest2.getVal()
#        Area_temp = Area_temp + iTest2.getVal()
#        print "SB+[VR+SR]:", Area_temp
...
#	print "cor(0,1)", cor(0,1) 
#	cor_0_1 = cor(0,1)
#	print "cor_0_1:", cor_0_1
#	cor_0_1 = cor_0_1 +1
#	cor[0][1] = cor_0_1
#	print "cor(0,1)", cor(0,1)
	...
	print "parameter used to fit pseudo-data in SB"
        print "constVjet_value_fit_pseudo_data_SB:", constVjet_value_fit_pseudo_data_SB
	print "offsetVjet_value_fit_pseudo_data_SB:",offsetVjet_value_fit_pseudo_data_SB
	print "widthVjet_value_fit_pseudo_data_SB:",widthVjet_value_fit_pseudo_data_SB

        constVjet_same   = RooRealVar("constVjet_same",   "slope of the exp",  constVjet_value_fit_pseudo_data_SB , -1.,   0.)
        offsetVjet_same  = RooRealVar("offsetVjet_same",  "offset of the erf", offsetVjet_value_fit_pseudo_data_SB ,   -50., 200.)
        widthVjet_same   = RooRealVar("widthVjet_same",   "width of the erf",  widthVjet_value_fit_pseudo_data_SB ,     1., 200.)

        modelVjet_same = RooErfExpPdf("modelVjet_same", "error function for V+jets mass", J_mass, constVjet_same, offsetVjet_same, widthVjet_same)

	print ""
	Area_temp = 0
#	print "integral of modelVjet_same"
#        iTest2 = modelVjet_same.createIntegral(jetMassArg,RooFit.NormSet(jetMassArg), RooFit.Range("h_reasonable_range"))
#        print "iTest2 all range:", iTest2.getVal()
#        iTest2 = modelVjet_same.createIntegral(jetMassArg,RooFit.NormSet(jetMassArg), RooFit.Range("LSBrange,HSBrange"))
#        print "iTest2 SB only:", iTest2.getVal()
#        Area_temp = Area_temp + iTest2.getVal()
#        iTest2 = modelVjet_same.createIntegral(jetMassArg,RooFit.NormSet(jetMassArg), RooFit.Range("VRrange,SRrange"))
#        print "iTest2 VR+SR:", iTest2.getVal()
#        Area_temp = Area_temp + iTest2.getVal()
#        print "SB+[VR+SR]:", Area_temp

#        iTest2 = modelVjet_same.createIntegral(jetMassArg, RooFit.Range("h_reasonable_range"))
#        print "iTest2 all range:", iTest2.getVal()
#        iTest2 = modelVjet_same.createIntegral(jetMassArg, RooFit.Range("LSBrange,HSBrange"))
#        print "iTest2 SB only:", iTest2.getVal()
#        Area_temp = Area_temp + iTest2.getVal()
#        iTest2 = modelVjet_same.createIntegral(jetMassArg, RooFit.Range("VRrange,SRrange"))
#        print "iTest2 VR+SR:", iTest2.getVal()
#        Area_temp = Area_temp + iTest2.getVal()
#        print "SB+[VR+SR]:", Area_temp 
	...
	# plot
        ...
        frVjet_same = modelVjet_same.fitTo(pseudo_data_SB, RooFit.SumW2Error(True), RooFit.Range("LSBrange,HSBrange"), RooFit.Strategy(2), RooFit.Minimizer(minimizer_choose), RooFit.Save(1), RooFit.PrintLevel(1 if VERBOSE else -1))	

        constVjet_same.setVal(   constVjet_value_fit_pseudo_data_SB  ) 
        offsetVjet_same.setVal(  offsetVjet_value_fit_pseudo_data_SB ) 
        widthVjet_same.setVal(   widthVjet_value_fit_pseudo_data_SB  )

#        modelVjet_same.plotOn(Jmass_frame3,RooFit.LineColor(RooFit.kOrange),RooFit.Range("h_reasonable_range"))

#        print ""
#        Area_temp = 0
#        print "integral of modelVjet_same after fit SB"
#        iTest2 = modelVjet_same.createIntegral(jetMassArg,RooFit.NormSet(jetMassArg), RooFit.Range("h_reasonable_range"))
#        print "iTest2 all range:", iTest2.getVal()
#        iTest2 = modelVjet_same.createIntegral(jetMassArg,RooFit.NormSet(jetMassArg), RooFit.Range("LSBrange,HSBrange"))
#        print "iTest2 SB only:", iTest2.getVal()
...
#	print ""
	...
	# make PDF of +/-1 simga uncertainty of parameters and plot them

        constVjet_test2_error   = RooRealVar("constVjet_test2_error",   "slope of the exp", constVjet_value_fit_MC , -1.,   0.)
        offsetVjet_test2_error  = RooRealVar("offsetVjet_test2_error",  "offset of the erf", offsetVjet_value_fit_MC ,   -50., 200.)
        widthVjet_test2_error   = RooRealVar("widthVjet_test2_error",   "width of the erf", widthVjet_value_fit_MC ,     1., 200.)
        offsetVjet_test2_error.setConstant(True)

        modelVjet_test2_error = RooErfExpPdf("modelVjet_test2_error", "error function for V+jets mass", J_mass,constVjet_test2_error,offsetVjet_test2_error ,widthVjet_test2_error )

        frVjet_error = modelVjet_test2_error.fitTo(pseudo_data_SB, RooFit.SumW2Error(True), RooFit.Range("LSBrange,HSBrange"), RooFit.Strategy(2), RooFit.Minimizer(minimizer_choose), RooFit.Save(1), RooFit.PrintLevel(1 if VERBOSE else -1))

	# par1 plus
        par1_plus = par1_value + par1_error

	constVjet_test2_error.setVal(par1_plus )
	widthVjet_test2_error.setVal(par2_value )


        modelVjet_test2_error.plotOn(Jmass_frame3,RooFit.LineColor((RooFit.kGreen)+1),RooFit.Range("h_reasonable_range"))

#        print ""
#        Area_temp = 0
#        print "integral of modelVjet_test2_error after fit SB"
#        iTest2 = modelVjet_test2_error.createIntegral(jetMassArg,RooFit.NormSet(jetMassArg), RooFit.Range("h_reasonable_range"))
#        print "iTest2 all range:", iTest2.getVal()
#        iTest2 = modelVjet_test2_error.createIntegral(jetMassArg,RooFit.NormSet(jetMassArg), RooFit.Range("LSBrange,HSBrange"))
#        print "iTest2 SB only:", iTest2.getVal()
#        Area_temp = Area_temp + iTest2.getVal()
#        iTest2 = modelVjet_test2_error.createIntegral(jetMassArg,RooFit.NormSet(jetMassArg), RooFit.Range("VRrange,SRrange"))
#        print "iTest2 VR+SR:", iTest2.getVal()
#        Area_temp = Area_temp + iTest2.getVal()
#        print "SB+[VR+SR]:", Area_temp
#        print ""
...
#	print ""
#	print "another PDF with parameters"
#	print "constVjet_test2_error: ", constVjet_test2_error.getVal()
#	print "offsetVjet_test2_error: ", offsetVjet_test2_error.getVal()
#	print "widthVjet_test2_error: ", widthVjet_test2_error.getVal()
#	print ""

#        constVjet_test2_error.setVal( ( par1_plus - par1_value )*0.25 + par1_value )
#        modelVjet_test2_error.plotOn(Jmass_frame3,RooFit.LineColor((RooFit.kRed)+1),RooFit.Range("h_reasonable_range"))

#        constVjet_test2_error.setVal( ( par1_plus -  par1_value)*0.5 + par1_value )
#        modelVjet_test2_error.plotOn(Jmass_frame3,RooFit.LineColor((RooFit.kRed)+2),RooFit.Range("h_reasonable_range"))

#        constVjet_test2_error.setVal( ( par1_plus - par1_value )*0.75 + par1_value )
#        modelVjet_test2_error.plotOn(Jmass_frame3,RooFit.LineColor((RooFit.kRed)+3),RooFit.Range("h_reasonable_range"))

	# par1 minus
        par1_minus = par1_value - par1_error

        constVjet_test2_error.setVal(par1_minus )
        widthVjet_test2_error.setVal(par2_value )
        ...
        constVjet_test2_error.setVal(par1_value )
        widthVjet_test2_error.setVal(par2_plus  )

        modelVjet_test2_error.plotOn(Jmass_frame3,RooFit.LineColor((RooFit.kMagenta)+1),RooFit.Range("h_reasonable_range"))

        # par2 minus
        par2_minus = par2_value - par2_error

        constVjet_test2_error.setVal(par1_value )
        widthVjet_test2_error.setVal(par2_minus  )
...
#                pseudo_data_fluc = modelVjet_test.generate(RooArgSet(J_mass),nPseudo_data_fluc )
		...
		# calculation of generation 
                iGen_value_fix = modelVjet_test.createIntegral(jetMassArg,RooFit.NormSet(jetMassArg), RooFit.Range("SRrange"))

                iGen_All_fix = modelVjet_test.createIntegral(jetMassArg,RooFit.NormSet(jetMassArg), RooFit.Range("h_reasonable_range"))
                nGen_SR_fluc = pseudo_data_SR_fluc.sumEntries()
#                nGen_SR_fluc = nPseudo_data_fluc * (iGen_value_fix.getVal()/iGen_All_fix.getVal())
...
#		print "test offsetVjet_case1 after fit"
#		print "offsetVjet_case1:", offsetVjet_case1.getVal()
		...
		sigma_Fit = math.sqrt( nFit_SR_case1 ) 

		Bias_value_case1 = ( nFit_SR_case1 - nGen_SR_fluc )/ nGen_SR_fluc
		h_Bias_case1.Fill(Bias_value_case1)

#		pull_value_case1 = ( nFit_SR_case1 - nGen_SR_fluc )/ sigma_Gen_fluc
                pull_value_case1 = ( nFit_SR_case1 - nGen_SR_fluc )/ sigma_Fit
