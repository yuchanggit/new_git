...
/////// Alpha defined as ratio of two Exp 
class RooAlphaExpExp : public RooAbsPdf {
    public:
        RooAlphaExpExp();
        RooAlphaExpExp(const char *name, const char *title,
                          RooAbsReal& _x,
                          RooAbsReal& _c,
                          RooAbsReal& _ca);

        RooAlphaExpExp(const RooAlphaExpExp& other, const char* name=0) ;

        virtual TObject* clone(const char* newname) const { return new RooAlphaExpExp(*this,newname); }

        inline virtual ~RooAlphaExpExp() { }
