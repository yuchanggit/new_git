...
#                pseudo_data_fluc = modelVjet_test.generate(RooArgSet(J_mass),nPseudo_data_fluc )
		...
		# fit
        	frVjet_case1 = modelVjet_case1.fitTo(pseudo_data_SB_fluc, RooFit.SumW2Error(True), RooFit.Range("LSBrange,HSBrange"), RooFit.Strategy(2), RooFit.Minimizer("Minuit2"), RooFit.Save(1), RooFit.PrintLevel(1 if VERBOSE else -1))

		# calculate the bias
        	iFit_SR_case1 = modelVjet_case1.createIntegral(jetMassArg,RooFit.NormSet(jetMassArg), RooFit.Range("SRrange"))

        	Bias_value_case1 = ( iFit_SR_case1.getVal() - iGen_value_fix.getVal() ) / iGen_value_fix.getVal()
...
#		modelVjet_case2 = RooGenericPdf("modelVjet_case2", "powerlaw for X mass", "@0^@1", RooArgList(J_mass, a0Vjet_case2))
		...
		# fit
                ...
                Bias_value_case2 = ( iFit_SR_case2.getVal() - iGen_value_fix.getVal() ) / iGen_value_fix.getVal()
