...
# 	print frVjet_test2.Error()

#        print frVjet_test2.Error(1)
...
#	frVjet_test2.correlation("constVjet_test2").Print("v")
...
#	print frVjet_test2.Chi2()
#	print frVjet_test2.Error(1)
#        print type(frVjet_test2)
	#errors = frVjet_test2.Errors() 	
	#print "errors:", errors
...
#		print "nGen_SR_fluc:",nGen_SR_fluc
		...
		# fit
        	...
        	par1_fitresult = frVjet_case1.floatParsFinal().find("constVjet_case1")
        	par2_fitresult = frVjet_case1.floatParsFinal().find("widthVjet_case1")
                print ""
        	print "fit from toy MC in SB in loop"
        	print "par1 value:",par1_fitresult.getVal()
        	print "par1 error:",par1_fitresult.getError()
        	print "par2 value:",par2_fitresult.getVal()
        	print "par2 error:",par2_fitresult.getError()
