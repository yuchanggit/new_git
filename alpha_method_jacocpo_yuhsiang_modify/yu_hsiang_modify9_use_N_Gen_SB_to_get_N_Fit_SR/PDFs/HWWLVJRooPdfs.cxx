...
/// Alpha function given by the ratio of two exponential functions (CUSTOM VERSION)
ClassImp(RooAlphaExpExp)

RooAlphaExpExp::RooAlphaExpExp(){}

RooAlphaExpExp::RooAlphaExpExp(const char *name, const char *title,
           RooAbsReal& _x,
           RooAbsReal& _c,
           RooAbsReal& _ca) :
  RooAbsPdf(name,title),
...
RooAlphaExpExp::RooAlphaExpExp(const RooAlphaExpExp& other, const char* name) :
  RooAbsPdf(other,name),
  x("x",this,other.x),
  c("c",this,other.c),
  ca("ca",this,other.ca){ }

double RooAlphaExpExp::evaluate() const{
  return TMath::Exp(x*c)/TMath::Exp(x*ca);
}
