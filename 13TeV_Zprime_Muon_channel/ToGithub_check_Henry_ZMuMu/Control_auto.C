...
if( file_index!= 2 )continue;
  ...
  if(signal_background_flag == 0 )// read signal sample
	...
	xAna_muo_selection(file_name[file_index] , c1[file_index] , c2[file_index] , c3[file_index] , c4[file_index] , c5[file_index] , c6[file_index] , mass_point[file_index], eff, eff_err, dir_name , dir_flag , signal_background_flag , background_file_index ); 
  ...
  if(signal_background_flag == 1 )// read background sample
	...
	xAna_muo_selection( background_file_name[background_file_index] , c1[file_index] , c2[file_index] , c3[file_index] , c4[file_index] , c5[file_index] , c6[file_index] , mass_point[file_index], eff, eff_err, dir_name , dir_flag , signal_background_flag , background_file_index );
