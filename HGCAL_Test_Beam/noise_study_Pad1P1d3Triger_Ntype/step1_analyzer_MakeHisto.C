...
std::string ntuple_path = "/store/group/upgrade/HGCAL/TimingTB_H2_Apr2016/April2016";
...
void step1_analyzer_MakeHisto(std::string folder_name, int max_event_to_read)
{
  ...
  if( folder_name.find("SiPad1Trigger") != std::string::npos ){
    ...
    // 100 um 
    if ( folder_name.find("fit100Ele") != std::string::npos && folder_name.find("100GeV_600HV") == std::string::npos){ // for recoTrees_vSlope0_fit100Ele
      const int N_runs = 3;
      std::string runN[N_runs]={"3713","3714","3717"};
      Read_Tree( folder_name ,N_runs, runN, max_event_to_read );
    }

    if( folder_name.find("fit100Ele") != std::string::npos && folder_name.find("100GeV_600HV") != std::string::npos ){// for recoTrees_vSlope0_fit100Ele_100GeV_600HV
      const int N_runs = 1;
      std::string runN[N_runs]={"3729"};
      Read_Tree( folder_name ,N_runs, runN, max_event_to_read );   
    } 

    // 200 um
    if ( folder_name.find("fit200Ele") != std::string::npos && folder_name.find("100GeV_600HV") == std::string::npos){ // for recoTrees_vSlope0_fit200Ele
      const int N_runs = 2;
      std::string runN[N_runs]={"3772","3773"};
      Read_Tree( folder_name ,N_runs, runN, max_event_to_read );
    }

    if( folder_name.find("fit200Ele") != std::string::npos && folder_name.find("100GeV_600HV") != std::string::npos ){// for recoTrees_vSlope0_fit200Ele_100GeV_600HV
      const int N_runs = 2;
      std::string runN[N_runs]={"3767","3768"};
      Read_Tree( folder_name ,N_runs, runN, max_event_to_read );
    }

    // 300 um
    if ( folder_name.find("fit300Ele") != std::string::npos && folder_name.find("100GeV_600HV") == std::string::npos){ // for recoTrees_vSlope0_fit300Ele
      const int N_runs = 2;
      std::string runN[N_runs]={"3774","3775"};
      Read_Tree( folder_name ,N_runs, runN, max_event_to_read );
    }

    if( folder_name.find("fit300Ele") != std::string::npos && folder_name.find("100GeV_600HV") != std::string::npos ){// for recoTrees_vSlope0_fit300Ele_100GeV_600HV
      const int N_runs = 1;
      std::string runN[N_runs]={"3779"};
      Read_Tree( folder_name ,N_runs, runN, max_event_to_read );
    }
  }

  // SiPad1 Triger
  if( folder_name.find("SiPad3Trigger") != std::string::npos ){

    if ( folder_name.find("fit100Ele") != std::string::npos ){ // for recoTrees_vSlope0_fit100Ele
      const int N_runs = 3;
      std::string runN[N_runs]={"3713","3714","3717"};
      Read_Tree( folder_name ,N_runs, runN, max_event_to_read );
    }

    if ( folder_name.find("fit200Ele") != std::string::npos ){ // for recoTrees_vSlope0_fit200Ele
      const int N_runs = 2;
      std::string runN[N_runs]={"3772","3773"};
      Read_Tree( folder_name ,N_runs, runN, max_event_to_read );
    }

    if ( folder_name.find("fit300Ele") != std::string::npos ){ // for recoTrees_vSlope0_fit300Ele
      const int N_runs = 2;
      std::string runN[N_runs]={"3774","3775"};
      Read_Tree( folder_name ,N_runs, runN, max_event_to_read );
    }
...
void Read_Tree(std::string folder_name ,const int N_runs , std::string runN[], int max_event_to_read ){
  ...
  for(int i=0;i<7;i++){
    ...
    h_pedestal[i]    = new TH1F(h_name, h_name, 1000  , 0 , 1000  );
...
//  cout<<"hello "<< endl;
  ...
  if( folder_name.find("SiPad1Trigger") != std::string::npos ){
    if( folder_name.find("fit100Ele") != std::string::npos && folder_name.find("100GeV_600HV") == std::string::npos ) root_name = "Pad1Tri_Ele100um_150GeV_800HV.root";
    if( folder_name.find("fit100Ele") != std::string::npos && folder_name.find("100GeV_600HV") != std::string::npos ) root_name = "Pad1Tri_Ele100um_100GeV_600HV.root";

    if( folder_name.find("fit200Ele") != std::string::npos && folder_name.find("100GeV_600HV") == std::string::npos ) root_name = "Pad1Tri_Ele200um_150GeV_800HV.root";
    if( folder_name.find("fit200Ele") != std::string::npos && folder_name.find("100GeV_600HV") != std::string::npos ) root_name = "Pad1Tri_Ele200um_100GeV_600HV.root";

    if( folder_name.find("fit300Ele") != std::string::npos && folder_name.find("100GeV_600HV") == std::string::npos ) root_name = "Pad1Tri_Ele300um_150GeV_800HV.root";
    if( folder_name.find("fit300Ele") != std::string::npos && folder_name.find("100GeV_600HV") != std::string::npos ) root_name = "Pad1Tri_Ele300um_100GeV_600HV.root";

  }

  if( folder_name.find("SiPad3Trigger") != std::string::npos ){

    if( folder_name.find("fit100Ele") != std::string::npos && folder_name.find("100GeV_600HV") == std::string::npos ) root_name = "Pad3Tri_Ele100um_150GeV_800HV.root";
    if( folder_name.find("fit200Ele") != std::string::npos && folder_name.find("100GeV_600HV") == std::string::npos ) root_name = "Pad3Tri_Ele200um_150GeV_800HV.root";
    if( folder_name.find("fit300Ele") != std::string::npos && folder_name.find("100GeV_600HV") == std::string::npos ) root_name = "Pad3Tri_Ele300um_150GeV_800HV.root";
