...
std::string inputFolder = "/store/group/upgrade/HGCAL/TimingTB_H2_Apr2016/April2016/recoTrees_vSlope0/";
//std::string inputFolder = "/store/group/upgrade/HGCAL/TimingTB_H2_Apr2016/April2016/recoTrees_v3/";

TString save_path = "root_files_April_recoTrees_vSlope0/";
//TString save_path = "root_files_April_recoTrees/"; 
//TString save_path = "root_files_April_recoTrees_v3/";
...
//    if(jentry>1000)break;
  ...
  // save histogram
  TString root_name = save_path + runN + ".root";
  TFile* outFile = new TFile(root_name,"recreate"); 

  for(int i=1;i<7;i++){

    h_wave_max_vs_pedestalRMS[i]->GetXaxis()->SetTitle("wave_max [ADC]");
    h_wave_max_vs_pedestalRMS[i]->GetYaxis()->SetTitle("pedestalRMS [ADC]");
