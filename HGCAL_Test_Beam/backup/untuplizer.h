...
class TreeReader {
 ...
 public:
   ...
   TreeReader(const char* path, const char* treename = "H4treeReco");
   TreeReader(const char** paths, int npaths, const char* treename = "H4treeReco");
   TreeReader(std::vector<std::string> paths, const char* treename = "H4treeReco");
