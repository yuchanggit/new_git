...
string path = "/Users/index0192/alphabet_plot/Electron_channel/output_root/";
...
TFile* mc11 = TFile::Open((path + "DYJetsToLL_M-50_HT-100to200_13TeV_histogram.root").c_str());
TH1F* h_mc11 = (TH1F*)gDirectory->Get(title.c_str());
TFile* mc12 = TFile::Open((path + "DYJetsToLL_M-50_HT-200to400_13TeV_histogram.root").c_str());
TH1F* h_mc12 = (TH1F*)gDirectory->Get(title.c_str());
TFile* mc13 = TFile::Open((path + "DYJetsToLL_M-50_HT-400to600_13TeV_histogram.root").c_str());
TH1F* h_mc13 = (TH1F*)gDirectory->Get(title.c_str());
TFile* mc14 = TFile::Open((path + "DYJetsToLL_M-50_HT-600toInf_13TeV_histogram.root").c_str());
TH1F* h_mc14 = (TH1F*)gDirectory->Get(title.c_str());
TFile* mc2 = TFile::Open((path + "TT_TuneCUETP8M1_13TeV_histogram.root").c_str());
TH1F* h_mc2 = (TH1F*)gDirectory->Get(title.c_str());
TFile* mc3 = TFile::Open((path + "ZZ_TuneCUETP8M1_13TeV_histogram.root").c_str());
TH1F* h_mc3 = (TH1F*)gDirectory->Get(title.c_str());
TFile* mc4 = TFile::Open((path + "WZ_TuneCUETP8M1_13TeV_histogram.root").c_str());
TH1F* h_mc4 = (TH1F*)gDirectory->Get(title.c_str());
TFile* mc6 = TFile::Open((path + "WW_TuneCUETP8M1_13TeV_histogram.root").c_str());
TH1F* h_mc6 = (TH1F*)gDirectory->Get(title.c_str());
TFile* mc7 = TFile::Open((path + "ZH_HToBB_ZToLL_M125_13TeV_amcatnlo_histogram.root").c_str());
TH1F* h_mc7 = (TH1F*)gDirectory->Get(title.c_str());
TFile* mc8 = TFile::Open((path + "ZH_HToBB_ZToLL_M125_13TeV_powheg_histogram.root").c_str());
...
TFile* data_file = TFile::Open((path + "SingleElectron-combine_histogram.root").c_str());
TH1F* h_data = (TH1F*)gDirectory->Get(title.c_str());
...
if(title=="h_passDoubleBTagger_Jmass_wideBinning" || title=="h_passDoubleBTagger_Jmass" ) hs->SetTitle("Pass DoubleBTagger");
if(title=="h_failDoubleBTagger_Jmass_wideBinning" || title=="h_failDoubleBTagger_Jmass" ) hs->SetTitle("Fail DoubleBTagger");

if(title=="h_passDoubleBTagger_Jmass_wideBinning_diff"  ) hs->SetTitle("Pass DoubleBTagger Differential");
if(title=="h_failDoubleBTagger_Jmass_wideBinning_diff"  ) hs->SetTitle("Fail DoubleBTagger Differential");


hs->GetYaxis()->SetTitle("Events");
//if(title=="h_passDoubleBTagger_Jmass_wideBinning" || title=="h_failDoubleBTagger_Jmass_wideBinning" ) hs->GetYaxis()->SetTitle("Events / GeV");

if(title=="h_passDoubleBTagger_Jmass_wideBinning_diff"||title=="h_failDoubleBTagger_Jmass_wideBinning_diff"  ) hs->GetYaxis()->SetTitle("Events / GeV");
...
lar->DrawLatex(0.70, 0.94, "L = 12.7 fb^{-1} at #sqrt{s} = 13 TeV");
...
//  h_ratio->GetXaxis ()->SetTitle("FAT Jet Thea Corrected SoftDrop Mass [GeV/c^{2}]");
...
h_ratio->GetXaxis()->SetRangeUser(30, 200);
...
TLine *OLine = new TLine(30,1.,200,1.);
