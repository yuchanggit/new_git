...
save_path=/data7/yuchang/NCUGlobalTuples_80X/data_mu_temp/other_copy

dir_number=0001

file=../file_list_name_0001.txt
...
do
   ...
   echo "xrdcp -r root://grid71.phy.ncu.edu.tw//dpm/phy.ncu.edu.tw/home/cms/store/user/yuchang/SingleMuon/crab_SingleMuon-Run2016B-PromptReco-v2/160706_120755/$dir_number/$string1 $save_path/$dir_number/"

   xrdcp -r root://grid71.phy.ncu.edu.tw//dpm/phy.ncu.edu.tw/home/cms/store/user/yuchang/SingleMuon/crab_SingleMuon-Run2016B-PromptReco-v2/160706_120755/$dir_number/$string1 $save_path/$dir_number/
