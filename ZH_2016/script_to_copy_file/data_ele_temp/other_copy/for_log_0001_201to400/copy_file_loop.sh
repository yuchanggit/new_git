...
save_path=/data7/yuchang/NCUGlobalTuples_80X/data_ele_temp/other_copy
...
do
   ...
   xrdcp -r root://grid71.phy.ncu.edu.tw//dpm/phy.ncu.edu.tw/home/cms/store/user/yuchang/SingleElectron/crab_SingleElectron-Run2016B-PromptReco-v2/160706_120820/$dir_number/$string1 $save_path/$dir_number/
