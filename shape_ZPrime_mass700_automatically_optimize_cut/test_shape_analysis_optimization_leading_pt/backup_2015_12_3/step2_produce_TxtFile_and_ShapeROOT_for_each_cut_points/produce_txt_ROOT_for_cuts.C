...
//	cout<< signal_histo_name[signal_index][cut_index] << endl;
	h_Zprime_mass_of_signal_sample_and_cut[signal_index][cut_index] = new TH1D(signal_histo_name[signal_index][cut_index],"",1000,0,5000);
  ...
  for(int DYJetHT_index=0;DYJetHT_index<N_DYJetsHTbin_background_points; DYJetHT_index++){
    for(int cut_index=0;cut_index<N_cut_points; cut_index++ ){
        ...
        h_Zprime_mass_of_DYJetHT_sample_and_cut[DYJetHT_index][cut_index] = new TH1D(DYJetHT_histo_name[DYJetHT_index][cut_index],"",1000,0,5000);
...
//    cout<< Event_yield_signal_sample_and_cut[signal_index][0] << endl;
  ...
  for(int cut_index=0;cut_index<N_cut_points; cut_index++ ){ // the order of two loop is different to signal
    ...
    h_Zprime_mass_of_DYJetHT_and_cut[cut_index] = new TH1D(DYJetHT_histo_name_combine[cut_index],"",1000,0,5000);
