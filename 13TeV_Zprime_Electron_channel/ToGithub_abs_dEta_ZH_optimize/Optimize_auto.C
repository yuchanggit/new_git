...
#include <string>
#include "TCanvas.h"
#include "xAna_ele_subleading_ele_pt_optimize.C"
...
/*
TString file_name[N_mass_points] = {
"ZprimeZhbb_new/ZprimeToZhToZlephbb_narrow_M-600_13TeV-madgraph.root",
"ZprimeZhbb_new/ZprimeToZhToZlephbb_narrow_M-800_13TeV-madgraph.root",
"ZprimeZhbb_new/ZprimeToZhToZlephbb_narrow_M-1000_13TeV-madgraph.root",
"ZprimeZhbb_new/ZprimeToZhToZlephbb_narrow_M-1200_13TeV-madgraph.root",
"ZprimeZhbb_new/ZprimeToZhToZlephbb_narrow_M-1400_13TeV-madgraph.root",
"ZprimeZhbb_new/ZprimeToZhToZlephbb_narrow_M-1600_13TeV-madgraph.root",
"ZprimeZhbb_new/ZprimeToZhToZlephbb_narrow_M-1800_13TeV-madgraph.root",
"ZprimeZhbb_new/ZprimeToZhToZlephbb_narrow_M-2000_13TeV-madgraph.root",
"ZprimeZhbb_new/ZprimeToZhToZlephbb_narrow_M-2500_13TeV-madgraph.root",
"ZprimeZhbb_new/ZprimeToZhToZlephbb_narrow_M-3000_13TeV-madgraph.root",
"ZprimeZhbb_new/ZprimeToZhToZlephbb_narrow_M-3500_13TeV-madgraph.root",
"ZprimeZhbb_new/ZprimeToZhToZlephbb_narrow_M-4000_13TeV-madgraph.root",
"ZprimeZhbb_new/ZprimeToZhToZlephbb_narrow_M-4500_13TeV-madgraph.root"
                        };
*/
...
"DYJetsHTBins25nsSamples/DYJetsToLL_M-50_HT-100to200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root",
"DYJetsHTBins25nsSamples/DYJetsToLL_M-50_HT-200to400_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root",
"DYJetsHTBins25nsSamples/DYJetsToLL_M-50_HT-400to600_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root",
"DYJetsHTBins25nsSamples/DYJetsToLL_M-50_HT-600toInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root"
                        };
*/
...
//if( file_index!= 2 )continue;
  ...
  if(signal_background_flag == 0 )// read signal sample
	...
	xAna_ele_subleading_ele_pt_optimize(file_name[file_index] , c1[file_index] , c2[file_index] , c3[file_index] , c4[file_index] , c5[file_index] , c6[file_index] , mass_point[file_index], eff, eff_err, dir_name , dir_flag , signal_background_flag , background_file_index ); 
  ...
  if(signal_background_flag == 1 )// read background sample
	...
	xAna_ele_subleading_ele_pt_optimize( background_file_name[background_file_index] , c1[file_index] , c2[file_index] , c3[file_index] , c4[file_index] , c5[file_index] , c6[file_index] , mass_point[file_index], eff, eff_err, dir_name , dir_flag , signal_background_flag , background_file_index );
