...
//cout<<"ig: "<< ig <<endl;
//cout<<"genParId[ig]: "<< genParId[ig] <<endl;

      int da1=genDa1[ig];
      int da2=genDa2[ig];

//cout<<"genMo1[ig]: "<< genMo1[ig] <<endl;
//cout<<"genMo2[ig]: "<< genMo2[ig] <<endl;

//cout<<"genDa1[ig]: "<< genDa1[ig] <<endl;
//cout<<"genDa2[ig]: "<< genDa2[ig] <<endl;
...
//cout<<"leadingIndex: " << leadingIndex << endl;
//cout<<"subleadingIndex: " << subleadingIndex << endl;
