...
// signal_background_flag = 0; // Zprime signal
 signal_background_flag = 1; // DYJets_HT background
  ...
  for(int file_index=0;file_index<1;file_index++){// which signal mass points you want ?
...
xAna_ele_subleading_ele_pt_optimize( background_file_name[background_file_index] , c1[file_index] , c2[file_index] , c3[file_index] , c4[file_index] , c5[file_index] , c6[file_index] , 
mass_point[file_index], eff, eff_err, dir_name , dir_flag , signal_background_flag , background_file_index );
