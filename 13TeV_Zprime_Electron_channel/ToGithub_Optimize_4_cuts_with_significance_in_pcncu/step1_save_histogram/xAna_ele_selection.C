...
int mass_point ,double eff,double eff_err, TString dir_name, int dir_flag ,int signal_background_flag, int background_file_index ){
  ...
  TString title2a = Form("ele 1st pT for Zprime mass = %d",mass_point);
  TString title2b = Form("ele 2nd pT for Zprime mass = %d",mass_point);
  ...
  TString title7a = Form("|dEta| of ZH for Zprime mass = %d",mass_point);
  TString title7b = Form("|dRapidity| of ZH for Zprime mass = %d",mass_point);
  TString title8 = Form("|dPhi| of ZH for Zprime mass = %d",mass_point);
  TString title9 = Form("dR of ZH for Zprime mass = %d",mass_point);

  TH1D* h_ele_1st_pT = new TH1D("h_ele_1st_pT", title2a ,3000 , 0,3000 );
  TH1D* h_ele_2nd_pT = new TH1D("h_ele_2nd_pT", title2b ,3000 , 0,3000 );
  ...
  TH1D* h_abs_dEta_ZH = new TH1D("h_abs_dEta_ZH",title7a ,120,-1,5);
  TH1D* h_abs_dRapidity_ZH = new TH1D("h_abs_dRapidity_ZH",title7b ,120,-1,5);
...

{
    ...
    h_ele_1st_pT->Fill( thisEle->Pt() );
}
 
{
      int ie = Z_electron_index[1];// sub-leading electron
    TLorentzVector* thisEle = (TLorentzVector*)eleP4->At(ie);
    h_ele_2nd_pT->Fill( thisEle->Pt() );
}
	...
	h_abs_dEta_ZH ->Fill( abs_dEta );
        h_abs_dRapidity_ZH ->Fill( abs_dRapidity );
...
delete h_ele_1st_pT;
delete h_ele_2nd_pT;
delete h_Zprime_mass;
delete h_abs_dEta_ZH;
delete h_abs_dRapidity_ZH;
delete h_abs_dPhi_ZH;
delete h_abs_dR_ZH;
